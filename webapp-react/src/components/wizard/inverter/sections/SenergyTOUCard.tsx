...
interface SenergyTOUCardProps {
  inverterId: string
  batteryOperation?: 'Voltage' | 'State of charge' | null
}

export const SenergyTOUCard: React.FC<SenergyTOUCardProps> = ({
  inverterId,
  batteryOperation
}) => {
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm" style={{ color: textSecondary }}>
            Configure time-based charge/discharge windows (3 charge + 3 discharge)
          </p>
        </div>
      </div>
